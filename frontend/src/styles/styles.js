const styles = {
  ...
  productTitle: 'text-[25px] font-[600] font-Roboto text-orange-gold',
  ...
  button: 'w-[150px] bg-black h-[50px] my-3 flex items-center justify-center rounded-xl cursor-pointer shadow-lg',
  cart_button: "px-[20px] h-[38px] rounded-[20px] bg-gradient-to-r from-orange to-gold flex items-center justify-center cursor-pointer shadow-lg",
  cart_button_text: "text-[#fff] text-[16px] font-[600]",
  input: "w-full border p-1 rounded-[5px] shadow",
