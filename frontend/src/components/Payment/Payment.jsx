...
const Payment = () => {
  ...
  const payWithPaystack = (e) => {
    ...
    let handler = window.PaystackPop.setup({
      key: 'pk_live_fe6f4bd1d1fc792ab8c510ea6944cefeddfb0f4a', // Replace with your actual Paystack public key
      ...
      <div id="paymentForm">
        ...
        <div className="form-group">
          ...
          <input
            type="email"
            id="email-address"
            value="hafrisys@gmail.com" // Set the value attribute to pre-fill the email
        ...
        <div className="form-group">
          ...
          <input
            type="tel"
            id="amount"
            value="1" // Set the value attribute to pre-fill the amount
        ...
        <div className="form-group">
          ...
          <input
            type="text"
            id="first-name"
            value="nana" // Set the value attribute to insert "nana" into the field
          />
        </div> */}
...
const CartData = ({ orderData }) => {
  ...
  return (
    <div className="w-full bg-[#fff] rounded-md p-5 pb-8">
      ...
      <br />
      <div className="flex justify-between">
        <h3 className="text-[16px] font-[400] text-[#000000a4]">Delivery Fee:</h3>
