    ...
    <>
      <div className={`${styles.section}`}>
        <div className="hidden 800px:h-[50px] 800px:my-[20px] 800px:flex items-center justify-between">
          <div>
            <Link to="/">
              <h1 className="text-orange-500 flex items-center">
                APPCODE <IoIosArrowForward className="ml-1" />
              </h1>
              <img
                src="./HAFRI SYS no bg.png"
                alt=""
              />
            </Link>
          </div>
          ...
          <div className={`${styles.button}`}>
            <Link to={`${isSeller ? "/dashboard" : "/shop-create"}`}>
              <h1 className="text-orange-500 flex items-center">
                {isSeller ? "Go Dashboard" : "Sell Here"}{" "}
      ...
      w-full h-[60px] bg-orange-500 z-50 top-0 left-0 shadow-sm 800px:hidden`}
      >
          ...
          >
            <div className="fixed w-[70%] bg-[#fff] h-screen top-0 left-0 z-10 overflow-y-scroll">
              ...
              <div className={`${styles.button} ml-4 !rounded-[4px]`}>
                <Link to="/shop-create">
                  <h1 className="text-orange-500 flex items-center">
                    Sell Here <IoIosArrowForward className="ml-1" />
                  </h1>
                </Link>
              </div>
              <br />
